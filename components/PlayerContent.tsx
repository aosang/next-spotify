...
const PlayerContent: React.FC<PlayerContentProps> = ({ song, songUrl }) => {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 h-full">
      ...
      <div onClick={handlePlay} className="hidden h-full md:flex justify-center items-center w-full max-w-[722px] gap-x-6">
        ...
        <div className="flex items-center h-10 w-10 rounded-full bg-white p-1 cursor-pointer">
          <Icon size={30} className="text-black ml-[1.5px]"/>
        </div>
